...
public class PensionadoRespuesta {
    ...
    private String tipoIdentificacion; // <-- 3. Renombrado (antes tipoIdPersona)
    ...
    private String estadoPersona; // <-- 5. El nombre del campo se mantiene, pero ahora representa un Enum

    @Schema(description = "Género de la persona", example = "MASCULINO")
    private String generoPersona; // <-- 6. El nombre del campo se mantiene, pero ahora representa un Enum
